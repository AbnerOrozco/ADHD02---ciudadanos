        ...
        <table class="table table-border table-striped">
            ...
            <tbody id="region">
                ...
                <tr>
                    ...
                    <td>
                        <a href="editar_region/<?php echo $region['cod_region']; ?>" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                        <a href="eliminar_region/<?php echo $region['cod_region']; ?>" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                    </td>
                </tr>
                    <?php
                    endforeach;
...
<script>
    document.getElementById('searchInput').addEventListener('keyup', function() {
        ...
        var rows = document.querySelectorAll('#region tr');
